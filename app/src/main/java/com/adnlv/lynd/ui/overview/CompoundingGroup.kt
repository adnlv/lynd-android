...
fun CompoundingGroup(
    ...
    LazyColumn(
        ...
        item {
            Text(
                text = "Compare the long-term wealth impact of spending bond payouts versus reinvesting them back into fixed income.",
        ...
        // Prevailing rate switch chips
        item {
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                Text(
                    text = "Prevailing Reinvestment Rate",
        ...
        uiState.compoundingSimulation?.let { simulation ->
            item {
                CompoundingMetricCard(simulation = simulation)
            }

            // Visual comparison chart card
            item {
                CompoundingChartCard(simulation = simulation)
            }
        }
            ...
            Card(
                ...
                Row(
                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
                        ...
                        Text(
                            text = "When you reinvest coupons each month, subsequent coupons earn interest on interest. Over a 5-to-10 year horizon, this reinvestment snowball creates significant additional capital.",
